...
fn analyze_one_file(f: &ParsedFile, ctx: &AnalysisContext<'_>) -> (Vec<Finding>, FileTimings) {
    ...
    let fa = FileAnalysis {
        ...
        check_uninitialized_properties: ctx.rule_options.check_uninitialized_properties,
        check_this_only: ctx.rule_options.check_this_only,
        check_too_wide_return_public: ctx.rule_options.check_too_wide_return_public,
